...
let g:tagbar_type_rust = {
    \ 'ctagstype' : 'rust',
    \ 'kinds' : [
        \'q:functions,function definitions',
        \'w:types,type definitions',
        \'e:enum,enumeration names',
        \'r:structure names',
        \'y:modules,module names',
        \'u:consts,static constants',
        \'o:traits,traits',
        \'p:impls,trait implementations',
